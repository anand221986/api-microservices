...
let UtilService = class UtilService {
    ...
    constructor(config) {
        this.config = config;
        this.NODE_ENVIRONMENT = this.config.get('NODE_ENV', 'local');
        this.DB_HOST = this.config.getOrThrow('DB_HOST');
        this.DB_USER = this.config.getOrThrow('DB_USER');
        this.DB_PORT = Number(this.config.getOrThrow('DB_PORT'));
        this.DB_PASSWORD = this.config.getOrThrow('DB_PASSWORD');
        this.DB_DATABASE =
            this.NODE_ENVIRONMENT === 'production'
                ? this.config.getOrThrow('DB_DATABASE_PROD')
                : this.config.getOrThrow('DB_DATABASE');
    }
